...
public enum Categoria {
    ...
    THRILLER_E_SUSPENSE(6), FICÇÃO_HISTÓRICA(7), ROMANCE(8), NOVELA(9), FICÇÃO_FEMININA(10), FICÇÃO(11),
    ...
    VIAGEM(24), CRIMES_REAIS(25), HUMOR(26), ENSAIOS(27), SÁTIRA(28), RELIGIÃO_E_ESPIRITUALIDADE(29),
